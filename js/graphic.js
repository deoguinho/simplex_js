...
function graphic() {
    ...
    let letter = 'A';
    for (let i = 0; i < points.length; i++) {
        console.log('interseção : ' + points[i].x.toString() + '  ' + points[i].y.toString());
    ...
    if (valid.length === 0) {
        console.log("Problema irrealizável: não admite soluções viáveis");
    ...
    sol_opt = valid[0];
    console.log('nome dos pontos factíveiss : ' + valid.length.toString());
    for (let i = 0; i < valid.length; i++) {
        console.log('solução factível '+ (i + 1).toString() +' : ' + valid[i].x.toString() + '  ' + valid[i].y.toString());
    ...
    if (non_bornee === false) {
        ...
        console.log('valor ótimo : ' + val_opt.toString());
        console.log('solução ótima : X1 = ' + sol_opt.x.toString() + ' X2 = ' + sol_opt.y.toString());
    }
    else {
        console.log("Problema ilimitado: nenhuma das soluções viáveis ​​é ideal");
        document.getElementById('graph_array').style.display = 'none';
        document.getElementById('note').style.display = 'none';
